...
void mc_InitRPCHelpMap17()
{
    ...
    mapHelpStrings.insert(std::make_pair("removeservicequantity",
        ...
        "\nArguments:\n"
        "1. \"service creator\"             (string, required) Address, must be address of service creator.\n"
        "2. \"asset holder\"                (string, required) Address, must be the asset holder of service\n"
        "3. \"txid\"                        (string, required) Transaction ID of the service to be updated\n"
        "4. \"quantity\"                    (string, required) Amount to burn from service\n"
        "\nExample:\n"
        + HelpExampleCli("addservicequantity", "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd 5d06edd7a0dbd0d83478c25fbf30cf3f07ceac45d9ced1591f6bd982fb878647 100")
    ));
